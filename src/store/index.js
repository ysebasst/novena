...
export default new Vuex.Store({
  state: {
    ...
    opciones: [
      ...
      {
        name: "ORACIÓN A LA SANTÍSIMA VÍRGEN",
        contenido: [
  ...
  actions: {
    obtenerSize({ commit }) {
      if (localStorage.getItem("fontSize")) {
        const payload = localStorage.getItem("fontSize");
        commit("cambiarSize", payload);
      }
    },
  },
  modules: {},
